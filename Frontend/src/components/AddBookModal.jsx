            ...
            <div className="form-container">
                ...
                <form autoComplete="off">
                    ...
                    <div className="form-group">
                        ...
                        <input type="text" id="email" name="email" onChange={(e)=>setFormData({...formData,'title':e.target.value})} className="form-group__form-input" required />
                    </div>

                    <div className="form-group">
                        <label className="fieldNames" htmlFor="phone">Author</label>
                        <input type="text" id="phone" name="phone" onChange={(e)=>setFormData({...formData,'author':e.target.value})} className="form-group__form-input" required />
                    </div>

                    <div className="form-group">
                        <label className="fieldNames" htmlFor="phone">Description</label>
                        <input type="text" id="phone" name="phone" onChange={(e)=>setFormData({...formData,'description':e.target.value})} className="form-group__form-input" required />
                    </div>

                    <div className="name-fields name-fields--margin-bottom-large">
                        <div className="form-group">
                            <label className="fieldNames" htmlFor="first-name">Quantity</label>
                            <input type="text" id="first-name" name="first-name" onChange={(e)=>setFormData({...formData,'quantity':e.target.value})} className="name-fields__form-input1" required />
                        </div>
                        <div className="form-group">
                            <label className="fieldNames" htmlFor="last-name">BookID</label>
                            <input type="text" id="last-name" name="last-name" onChange={(e)=>setFormData({...formData,'book_id':e.target.value})} className="name-fields__form-input2" required />
                        </div>
                    </div>
